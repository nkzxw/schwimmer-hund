...
# LINK: 
g++ -L"$BOOST_ROOT/stage/lib/" -o"$src_dir/../bin/test"  $src_dir/libs/os_services/test/test.o   -lboost_thread-gcc44-mt-d-1_41 -lboost_system-gcc44-mt-d-1_41 -lboost_filesystem-gcc44-mt-d-1_41 -lboost_unit_test_framework-gcc44-mt-d-1_41 &>> compilation.log
g++ -L"$BOOST_ROOT/stage/lib/" -o"$src_dir/../bin/stress_test_watcher"  $src_dir/libs/os_services/test/stress_test_watcher.o   -lboost_thread-gcc44-mt-d-1_41 -lboost_system-gcc44-mt-d-1_41 -lboost_filesystem-gcc44-mt-d-1_41 -lboost_unit_test_framework-gcc44-mt-d-1_41 &>> compilation.log
g++ -L"$BOOST_ROOT/stage/lib/" -o"$src_dir/../bin/stress_test_file_generator"  $src_dir/libs/os_services/test/stress_test_file_generator.o   -lboost_thread-gcc44-mt-d-1_41 -lboost_system-gcc44-mt-d-1_41 -lboost_filesystem-gcc44-mt-d-1_41 -lboost_unit_test_framework-gcc44-mt-d-1_41 &>> compilation.log
g++ -L"$BOOST_ROOT/stage/lib/" -o"$src_dir/../bin/stress_test_file_generator_and_watcher"  $src_dir/libs/os_services/test/stress_test_file_generator_and_watcher.o   -lboost_thread-gcc44-mt-d-1_41 -lboost_system-gcc44-mt-d-1_41 -lboost_filesystem-gcc44-mt-d-1_41 -lboost_unit_test_framework-gcc44-mt-d-1_41 &>> compilation.log
