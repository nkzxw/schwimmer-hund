#ifndef BOOST_OS_SERVICES_DETAIL_WIN32_LEGACY_HPP_INCLUDED
#define BOOST_OS_SERVICES_DETAIL_WIN32_LEGACY_HPP_INCLUDED
...
#endif // BOOST_OS_SERVICES_DETAIL_WIN32_LEGACY_HPP_INCLUDED
