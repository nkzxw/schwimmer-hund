#ifndef BOOST_OS_SERVICES_DETAIL_KQUEUE_WRAPPER_DUMMY_HPP
#define BOOST_OS_SERVICES_DETAIL_KQUEUE_WRAPPER_DUMMY_HPP
...
#endif // BOOST_OS_SERVICES_DETAIL_KQUEUE_WRAPPER_DUMMY_HPP
