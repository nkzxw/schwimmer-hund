...
//                        }
//                        //
//                        lstrcpyn((LPSTR)FileName, (LPSTR)fni->FileName, fni->FileNameLength / sizeof(WCHAR) + 1);
...
//		 // IniFile );
//
//	  memset(DirList, 0, MAX_DIRS*MAX_PATH);
//	  strcpy(DirList, "C:\\temp1");
//	  strcpy(DirList+strlen(DirList)+1, "C:\\temp2");
//
