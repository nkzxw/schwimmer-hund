#ifndef BOOST_OS_SERVICES_DETAIL_BASE_IMPL_HPP_INCLUDED
#define BOOST_OS_SERVICES_DETAIL_BASE_IMPL_HPP_INCLUDED
...
#endif // BOOST_OS_SERVICES_DETAIL_BASE_IMPL_HPP_INCLUDED
