...
# LINK: 
g++ -L"$BOOST_ROOT/stage/lib/" -o"PortableFileSystemWatcher"  $src_dir/libs/os_services/test/test.o   -lboost_thread-gcc42-mt-d-1_42 -lboost_system-gcc42-mt-d-1_42 -lboost_filesystem-gcc42-mt-d-1_42
