...
g++ -L"$BOOST_ROOT/stage/lib/" -o"$src_dir/../bin/stress_test_creation_watcher"  $src_dir/libs/os_services/test/stress_test_creation_watcher.o   -lboost_thread-gcc44-mt-d-1_41 -lboost_system-gcc44-mt-d-1_41 -lboost_filesystem-gcc44-mt-d-1_41 -lboost_unit_test_framework-gcc44-mt-d-1_41 &>> compilation.log
